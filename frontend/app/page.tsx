  ...
  return (
    <main className="relative w-screen h-screen flex flex-col items-center justify-center overflow-hidden"
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 animate-slide-up">
        <p className="text-xs font-medium tracking-[0.3em] text-gray-500 uppercase mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl">
          ...
          <button
            ...
            className="group relative p-6 rounded-2xl text-left overflow-hidden transition-all duration-300 hover:scale-[1.02]"
            style={{
              background: "#202026",
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-3xl font-bold mb-2" style={{ color: "#F0F0F0" }}>
              ...
              <div className="mt-4 text-xs opacity-50 group-hover:opacity-90 transition-opacity"
                   style={{ color: "#CC7070" }}>
      ...
      <div className="absolute bottom-6 right-6 text-xs text-gray-700 text-right leading-relaxed">
